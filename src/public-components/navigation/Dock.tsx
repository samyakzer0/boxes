...
export const DockDemo: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center gap-8 p-8">
            <span className="bg-gradient-to-b from-neo-black to-neo-gray-400 bg-clip-text text-center text-5xl font-bold uppercase leading-none text-transparent">
                Dock
            </span>
            <Dock>
                {DATA.navbar.map((item) => (
                    <DockIcon key={item.label}>
                        <a
                            ...
                            className="flex h-12 w-12 items-center justify-center border-2 border-neo-black bg-neo-white hover:bg-neo-gray-100 transition-colors"
                            title={item.label}
                        >
                ...
                <div className="mx-2 h-8 w-0 border-l-2 border-neo-black" />
